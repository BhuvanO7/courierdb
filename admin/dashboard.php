...
<div class="admintitle">
    <div>
    <h5 ><a href="../index.php" style="float: left; margin-left:20px; color:#f9829b;">LoginAsUser</a></h5>
    <h5 ><a href="logout.php" style="float: right; margin-right:20px; color:#f9829b;">LogOut</a></h5>
    </div>
...
<form style="position: center;color:#f9829b;font-weight:bold;font-size:50px">
